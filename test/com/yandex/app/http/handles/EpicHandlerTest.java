...
public class EpicHandlerTest extends HttpTaskServerTest {
    ...
    public void getEpicTest() throws InterruptedException, IOException {
        ...
        epic1.setEndTimeEpic(LocalDateTime.of(2024, 1, 1, 5, 30));
        epic1.setDuration("PT1H30M");
    ...
    public void getEpicsTest() throws InterruptedException, IOException {
        ...
        Epic epic2 = new Epic("Test Epic2", "Test");

        epic1.setStartTime(LocalDateTime.of(2024, 1, 1, 0, 0));
        epic1.setEndTimeEpic(LocalDateTime.of(2024, 1, 1, 1, 30));
        epic1.setDuration("PT1H30M");
    ...
    public void updateEpicTest() throws IOException, InterruptedException {
        ...
        SubTask subTask = new SubTask("Test SubTask1", "Test", Status.NEW, "PT30M",
                LocalDateTime.of(2024, 1, 1, 4, 10), 1);
        taskManager.putNewSubTask(subTask);

        Epic epic1 = new Epic("Test Epic1", "Test", 1);

        epic1.setStartTime(LocalDateTime.of(2024, 1, 1, 4, 10));
        epic1.setEndTimeEpic(LocalDateTime.of(2024, 1, 1, 4, 40));
        epic1.setDuration("PT30M");
        String taskJson = gson.toJson(epic1);
